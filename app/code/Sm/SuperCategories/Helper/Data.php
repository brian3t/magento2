...
-------------------------------------------------------------------------*/
namespace Sm\SuperCategories\Helper;
use Magento\Framework\Filesystem;
use Magento\Framework\ObjectManagerInterface;
use Magento\Store\Model\StoreManagerInterface;
use Magento\Framework\App\Helper\AbstractHelper;
use Magento\Framework\App\Filesystem\DirectoryList;
use Sm\SuperCategories\Block\SuperCategories;
...
class Data extends AbstractHelper
{
	...
	public function __construct(
		...
		\Sm\SuperCategories\Block\SuperCategories $block
	){
	...
	public function getProductImage($product, $_config, $prefix = 'imgcfgcat')
	{
	...
	private function getProductImages($product, $_config, $prefix = 'img')
	{
		...
		$_placeholder = ($placeholder != '' && strpos($placeholder, 'http') !== false) ? $placeholder :  $this->_block->getViewFileUrl('Sm_SuperCategories::images/nophoto.jpg');
	...
	public function _resizeImage($file, $config = [], $type = "product", $folder = 'resized')
	{
		...
		if(strpos($_file_name,'nophoto.jpg') !== false){
			$_media_dir = '';
			$baseUrl = $this->_storeManager->getStore()->getBaseUrl().'pub/';
			$_file_name2 = str_replace($baseUrl, '', $file);
			$_file_name2 = $baseDirPub.$_file_name2;
		}else{
