	...
	\Magento\Backend\Block\Widget\Tab\TabInterface
{
	...
	public function __construct(
		...
		$this->_dataValueObject = $dataObject;
		...
		$type->setAfterElementHtml('
					<script type="text/javascript">
						...
						require([
							...
							$$(".field-limit_category").each(function(element){
								element.hide();
							});
								
							$$(".field-limit_sub_category").each(function(element){
								element.hide();
							});
