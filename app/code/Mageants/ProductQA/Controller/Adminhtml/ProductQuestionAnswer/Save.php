...
class Save extends \Mageants\ProductQA\Controller\Adminhtml\ProductQuestionAnswer
{
     ...
     * 
     */
	const RESOURCE_ID = 'Mageants_ProductQA::productanswer_save';
	 /**
     * Upload model
     * 
		...
		{	
            ...
            try 
			{
                ...
                if($productquestionanswer->getStatus() == 1){
                   $productquestionanswer_mailData = $productquestionanswer->getCollection()->addFieldToFilter('id',$productquestionanswer->getId());
