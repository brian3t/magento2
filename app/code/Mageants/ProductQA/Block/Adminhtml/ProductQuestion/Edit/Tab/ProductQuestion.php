...
class ProductQuestion extends \Magento\Backend\Block\Widget\Form\Generic implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
	...
	//$fieldset->addType('customer', 'Mageants\ProductQA\Block\Adminhtml\ProductQuestion\Edit\Tab\Renderer\CustomerColumn');
    ...
    <script type="text/javascript">		 
		  require([
				...
				new serializerController('productquestion_product_ids', [$prod_ids], [], productsGridJsObject, 'productquestion_product_ids');
			});				   
    </script>
HTML;
    }
