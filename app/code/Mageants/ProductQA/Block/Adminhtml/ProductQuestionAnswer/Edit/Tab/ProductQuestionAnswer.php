...
class ProductQuestionAnswer extends \Magento\Backend\Block\Widget\Form\Generic implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
	const FORM_NAME = 'mageants_productqa_question_form';
    /**
	...
	//$fieldset->addType('customer', 'Mageants\ProductQA\Block\Adminhtml\ProductQuestionAnswer\Edit\Tab\Renderer\CustomerColumn');
